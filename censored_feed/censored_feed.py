...
#doesn't register divergences in tweet ex capitalized or change in inflection

import openai
import random 

# couldn't remove key and still have functioning code
...
# attempt to recognize key in generated tweet if capitalized
  for i in tweet:
